...
//            
//            json = JSON.read(fromFile: "\(MissionPath)/mission_\(missionIndex)")!
//            
//            simpleCharJSONs = json["characters"]["\(characterIndex)"].array!
//            
//            
...
//            
//            json = JSON.read(fromFile: "\(DungeonPath)/dungeon_\(dungeonIndex)")!
//            let bossIndex = index % 100
//            boss = json["boss"][bossIndex].string!
//            simpleCharJSONs = json[kCharacters][boss].array!
//            
//        }
//        
//        
